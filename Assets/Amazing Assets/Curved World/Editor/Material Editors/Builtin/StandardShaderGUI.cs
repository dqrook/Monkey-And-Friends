...
namespace AmazingAssets.CurvedWorldEditor
{
    internal class StandardShaderGUI : ShaderGUI
    {
        ...
        public void FindProperties(MaterialProperty[] props)
        {
            ...
            CurvedWorldEditor.MaterialProperties.InitCurvedWorldMaterialProperties(props);
        }
        ...
        void DoNormalArea()
        {
            ...
            //        UnityEditor.EditorGUIUtility.TrTextContent("Bump scale is not supported on mobile platforms"),
            //        UnityEditor.EditorGUIUtility.TrTextContent("Fix Now")))
            //    {
