...
namespace AmazingAssets
{
    namespace CurvedWorldEditor
    {
        public static class EditorUtilities
        {
            ...
            public static string assetInstalledVersion = "2021.2";
            public static string assetStorePath = "content/173251";
            public static string assetStorePathShortLink = "http://u3d.as/1W8h";
            public static string assetForumPath = "https://forum.unity.com/threads/curved-world-2.344041/";
            ...
            static public string GetCurvedWorldEditorFolderPath()
            {
                ...
                {
                    curvedWorldEditorFolderPath = Path.Combine(AmazingAssets.EditorUtility.GetAmazingAssetsFolderPath(), "Curved World");
                }
            ...
            static public string GetCoreTransformFilePath()
            {
                ...
                {
                    curvedWorldTransformFilePath = GetCurvedWorldEditorFolderPath();

                    curvedWorldTransformFilePath = Path.Combine(curvedWorldTransformFilePath, "Shaders");
                    curvedWorldTransformFilePath = Path.Combine(curvedWorldTransformFilePath, "Core");
                    curvedWorldTransformFilePath = Path.Combine(curvedWorldTransformFilePath, "CurvedWorldTransform");
                    curvedWorldTransformFilePath += ".cginc";
                }
