...
{
    public enum ANIMATORSTYLE { fourlegged, flying, bipedal, human, slime}
    [System.Serializable]
    ...
    public class SPAWNEDASSET
    {
        ...
        public Customizations Accessories;
    }
    public class PreviewManager : MonoBehaviour
    {
        ...
        public Slider AccessoriesSlider;
        public Slider FacesSlider;
        ...
        void SetupAccessoriesSlider()
        {
            AccessoriesSlider.maxValue = AssetDB[CurrentItemID].Customizations.Accessories.Count - 1;
            AccessoriesSlider.value = 0;
        }

        void SetupFacesSlider()
        {
            FacesSlider.maxValue = AssetDB[CurrentItemID].Customizations.FaceMaterials.Count - 1;
            FacesSlider.value = 0;
        }
        ...
        public void ACCESSORIESliderValueChanged()
        {
            OnStageItem().SetCurrentAccessory((int)AccessoriesSlider.value);
            SetupAssetName();
        }
        public void FACESSliderValueChanged()
        {
            OnStageItem().SetCurrentFace((int)FacesSlider.value);
        }
        #endregion
